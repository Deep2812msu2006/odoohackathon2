...
const CITY_LANDMARK_SLIDESHOWS = {
  Tokyo: [
    { title: 'Shibuya Crossing at Night', url: 'https://images.unsplash.com/photo-1542051841857-5f90071e7989?w=480&auto=format&fit=crop&q=75' },
    { title: 'Tokyo Tower & Evening Skyline', url: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?w=480&auto=format&fit=crop&q=75' },
    { title: 'Senso-ji Temple Asakusa', url: 'https://images.unsplash.com/photo-1536098561742-ca998e48cbcc?w=480&auto=format&fit=crop&q=75' },
    { title: 'Mount Fuji View from Tokyo', url: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=480&auto=format&fit=crop&q=75' },
  ],
  Paris: [
    { title: 'Eiffel Tower Golden Sunset', url: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=480&auto=format&fit=crop&q=75' },
    { title: 'Louvre Museum Glass Pyramid', url: 'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=480&auto=format&fit=crop&q=75' },
    { title: 'Arc de Triomphe Champs-Élysées', url: 'https://images.unsplash.com/photo-1509299349698-dd22323b5963?w=480&auto=format&fit=crop&q=75' },
    { title: 'Seine River Cruise & Notre Dame', url: 'https://images.unsplash.com/photo-1511739001486-6bfe10ce785f?w=480&auto=format&fit=crop&q=75' },
  ],
  'New York': [
    { title: 'Times Square Neon Nightlife', url: 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=480&auto=format&fit=crop&q=75' },
    { title: 'Brooklyn Bridge Manhattan View', url: 'https://images.unsplash.com/photo-1518391846015-55a9cc003b25?w=480&auto=format&fit=crop&q=75' },
    { title: 'Empire State & Mid-Town Skyline', url: 'https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?w=480&auto=format&fit=crop&q=75' },
    { title: 'Central Park Autumn Leaves', url: 'https://images.unsplash.com/photo-1534430480872-3498386e7856?w=480&auto=format&fit=crop&q=75' },
  ],
  Rome: [
    { title: 'Colosseum Ancient Roman Amphitheater', url: 'https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=480&auto=format&fit=crop&q=75' },
    { title: 'Trevi Fountain Golden Lights', url: 'https://images.unsplash.com/photo-1531572753322-ad063cecc140?w=480&auto=format&fit=crop&q=75' },
    { title: 'Pantheon & Historic Piazza', url: 'https://images.unsplash.com/photo-1529260830199-42c24126f198?w=480&auto=format&fit=crop&q=75' },
    { title: 'St. Peter Basilica Vatican View', url: 'https://images.unsplash.com/photo-1543429776-2782fc8e1acd?w=480&auto=format&fit=crop&q=75' },
  ],
  Kyoto: [
    { title: 'Fushimi Inari Shrine Torii Pathway', url: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=480&auto=format&fit=crop&q=75' },
    { title: 'Kinkaku-ji Golden Pavilion Over Pond', url: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?w=480&auto=format&fit=crop&q=75' },
    { title: 'Arashiyama Bamboo Grove Walkway', url: 'https://images.unsplash.com/photo-1542051841857-5f90071e7989?w=480&auto=format&fit=crop&q=75' },
    { title: 'Yasaka Pagoda & Higashiyama Streets', url: 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?w=480&auto=format&fit=crop&q=75' },
  ],
  Barcelona: [
    { title: 'Sagrada Família Gaudi Masterpiece', url: 'https://images.unsplash.com/photo-1511527661048-7fe73d85e9a4?w=480&auto=format&fit=crop&q=75' },
    { title: 'Park Güell Mosaic Serpent Terrace', url: 'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=480&auto=format&fit=crop&q=75' },
    { title: 'Casa Batlló Vibrant Architecture', url: 'https://images.unsplash.com/photo-1564221710304-0b37c8b9d729?w=480&auto=format&fit=crop&q=75' },
    { title: 'Barceloneta Beach Mediterranean Sun', url: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=480&auto=format&fit=crop&q=75' },
  ],
  'Cape Town': [
    { title: 'Table Mountain & Camp Bay Coast', url: 'https://images.unsplash.com/photo-1580618672591-eb180b1a973f?w=480&auto=format&fit=crop&q=75' },
    { title: 'Bo-Kaap Colorful Heritage Houses', url: 'https://images.unsplash.com/photo-1576485290814-1c72aa4bbb8e?w=480&auto=format&fit=crop&q=75' },
    { title: 'Boulders Beach African Penguins', url: 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=480&auto=format&fit=crop&q=75' },
    { title: 'Cape of Good Hope Atlantic View', url: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=480&auto=format&fit=crop&q=75' },
  ],
  Sydney: [
    { title: 'Sydney Opera House Sunset View', url: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?w=480&auto=format&fit=crop&q=75' },
    { title: 'Sydney Harbour Bridge Aerial View', url: 'https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?w=480&auto=format&fit=crop&q=75' },
    { title: 'Bondi Beach Coastal Waters', url: 'https://images.unsplash.com/photo-1549180030-48bf079fb38a?w=480&auto=format&fit=crop&q=75' },
    { title: 'Darling Harbour Evening Lights', url: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?w=480&auto=format&fit=crop&q=75' },
  ],
  London: [
    { title: 'Big Ben & Elizabeth Tower', url: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=480&auto=format&fit=crop&q=75' },
    { title: 'Tower Bridge over Thames River', url: 'https://images.unsplash.com/photo-1533929736458-ca588d08c8be?w=480&auto=format&fit=crop&q=75' },
    { title: 'London Eye Evening Reflections', url: 'https://images.unsplash.com/photo-1486299267070-83823f5448dd?w=480&auto=format&fit=crop&q=75' },
    { title: 'Piccadilly Circus Red Buses', url: 'https://images.unsplash.com/photo-1526129318478-62ed807ebdf9?w=480&auto=format&fit=crop&q=75' },
  ],
  Bangkok: [
    { title: 'Grand Palace Golden Stupas', url: 'https://images.unsplash.com/photo-1508009603885-50cf7c579365?w=480&auto=format&fit=crop&q=75' },
    { title: 'Wat Arun Temple of Dawn River View', url: 'https://images.unsplash.com/photo-1563492065599-3520f775eeed?w=480&auto=format&fit=crop&q=75' },
    { title: 'Damnoen Saduak Floating Market', url: 'https://images.unsplash.com/photo-1528181304800-259b08848526?w=480&auto=format&fit=crop&q=75' },
    { title: 'Chao Phraya River Night Skyline', url: 'https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?w=480&auto=format&fit=crop&q=75' },
  ],
  'Rio de Janeiro': [
    { title: 'Christ the Redeemer Corcovado Statue', url: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?w=480&auto=format&fit=crop&q=75' },
    { title: 'Sugarloaf Mountain Aerial Bay View', url: 'https://images.unsplash.com/photo-1516306580123-e6e52b1b7b5f?w=480&auto=format&fit=crop&q=75' },
    { title: 'Copacabana Beach Turquoise Ocean', url: 'https://images.unsplash.com/photo-1544984243-ec57ea16fe25?w=480&auto=format&fit=crop&q=75' },
    { title: 'Escadaria Selarón Mosaic Steps', url: 'https://images.unsplash.com/photo-1596701062351-8c2c14d1fdd0?w=480&auto=format&fit=crop&q=75' },
  ],
  Cairo: [
    { title: 'Pyramids of Giza & Great Sphinx', url: 'https://images.unsplash.com/photo-1503177119275-0aa32b3a9368?w=480&auto=format&fit=crop&q=75' },
    { title: 'Nile River Sunset Sail Boat', url: 'https://images.unsplash.com/photo-1509023464722-18d996393ca8?w=480&auto=format&fit=crop&q=75' },
    { title: 'Khan el-Khalili Historic Bazaar', url: 'https://images.unsplash.com/photo-1568322445389-f64ac2515020?w=480&auto=format&fit=crop&q=75' },
    { title: 'Mosque of Muhammad Ali Citadel', url: 'https://images.unsplash.com/photo-1553913861-c0fddf2619ee?w=480&auto=format&fit=crop&q=75' },
  ],
  Amsterdam: [
    { title: 'Historic Canal Houses & Bicycles', url: 'https://images.unsplash.com/photo-1512470876302-972faa2aa9a4?w=480&auto=format&fit=crop&q=75' },
    { title: 'Rijksmuseum Bridge & Canal View', url: 'https://images.unsplash.com/photo-1534351590666-13e3e96b5017?w=480&auto=format&fit=crop&q=75' },
    { title: 'Jordaan District Evening Lights', url: 'https://images.unsplash.com/photo-1468436139062-f60a71c5c892?w=480&auto=format&fit=crop&q=75' },
    { title: 'Spring Tulip Fields Horizon', url: 'https://images.unsplash.com/photo-1588714477688-cf28a50e94f7?w=480&auto=format&fit=crop&q=75' },
  ],
  Dubrovnik: [
    { title: 'Old Town Walls Coastal Fortifications', url: 'https://images.unsplash.com/photo-1547127796-06bb04e4b315?w=480&auto=format&fit=crop&q=75' },
    { title: 'Lovrijenac Fort & Adriatic Sea Coast', url: 'https://images.unsplash.com/photo-1486016006115-74a41448aea2?w=480&auto=format&fit=crop&q=75' },
    { title: 'Stradun Main Street Sunset Promenade', url: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=480&auto=format&fit=crop&q=75' },
    { title: 'Banje Beach Coastal Panorama View', url: 'https://images.unsplash.com/photo-1516483638261-f4dbaf036963?w=480&auto=format&fit=crop&q=75' },
  ],
  Mumbai: [
    { title: 'Gateway of India Waterfront Arch', url: 'https://images.unsplash.com/photo-1570168007204-dfb528c6958f?w=480&auto=format&fit=crop&q=75' },
    { title: 'Marine Drive Queen’s Necklace Curve', url: 'https://images.unsplash.com/photo-1562979314-bee7453e911c?w=480&auto=format&fit=crop&q=75' },
    { title: 'Taj Mahal Palace Iconic Hotel', url: 'https://images.unsplash.com/photo-1566552881560-0be862a7c445?w=480&auto=format&fit=crop&q=75' },
    { title: 'Chhatrapati Shivaji Terminus Station', url: 'https://images.unsplash.com/photo-1567168539593-59673ababaae?w=480&auto=format&fit=crop&q=75' },
  ],
  Reykjavik: [
    { title: 'Hallgrímskirkja Cathedral Expression', url: 'https://images.unsplash.com/photo-1504893524553-b855bce32c67?w=480&auto=format&fit=crop&q=75' },
    { title: 'Harpa Concert Hall Glass Architecture', url: 'https://images.unsplash.com/photo-1517411032315-54ef2cb783bb?w=480&auto=format&fit=crop&q=75' },
