...
import { User, LogOut, ShieldCheck, Search } from 'lucide-react';
    ...
    <div className="w-full flex items-center justify-between">
      ...
      <div className="relative w-72 hidden sm:block">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-slate-900/40 hover:bg-slate-900/60 focus:bg-slate-900/85 text-xs text-slate-350 rounded-xl border border-slate-800/80 focus:border-brand-500/50 outline-none transition-all placeholder-slate-550"
        />
      </div>
      <div className="sm:hidden text-sm font-semibold text-slate-200">GlobeTrotter</div>
